...
urlpatterns = [
    ...
    path('gestion/inscription-perisco/enfant', views.inscription_perisco_enfant, name='inscription-perisco-enfant'),
    path('gestion/inscription-perisco/equipier', views.inscription_perisco_equipier, name='inscription-perisco-equipier'),
    # JSON
